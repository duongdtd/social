...
import {
  Text, View, Image, FlatList, TouchableWithoutFeedback, Keyboard,
  StyleSheet, ScrollView, TouchableOpacity, Button, TextInput, KeyboardAvoidingView
} from 'react-native';
    ...
    <View style={{ flex: 1 }}>
      <View style={styles.containerView}>
          ...
          <View style={styles.container1}>
            <View style={styles.userInfo}>
              ...
              <View style={styles.userInfoText}>
                ...
                {post.creation != null ?
                  (<Text >{findDaysDiffrent(post.creation.seconds,
                    post.creation.nanoseconds)}</Text>) : (<View></View>)
                }
              </View>
            </View>
                    ...
                    props.navigation.navigate('Comments',
                      {
                        ...
                        image: props.route.params.imgOwn,caption: post.caption,
                        name: props.currentUser.nickname[props.currentUser.nickname.length-1],
                      ...
                      (<View style={{position:'absolute', right:20}}>
                        <TouchableOpacity onPress={() => {
                          firebase.firestore()
                            ...
                            .collection('UserPosts')
                            .doc(props.route.params.postId)
                            .collection('Comments').doc(item.id).delete()
                        }}
        ...
        <View style={styles.sendComment}>
          <TextInput
            style={{
              flex: 1, height: 36, flex: 4, borderWidth: 2,
